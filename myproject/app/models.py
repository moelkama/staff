...
class Article(models.Model):
    ...
    categories = models.CharField(max_length=20)  # String
    ...
    def __str__(self):
        return f"{self.article_name} {self.price} {self.src} {self.type} {self.categories} {self.height} {self.width} {self.how_many_available} {self.how_many_times_ordered}"
